      ...
      {loading ? (
        ...
        <div className="space-y-[20px]">
          ...
          <div className="bg-[var(--c-surface)] border border-[var(--c-border)] rounded-[var(--r-lg)] overflow-hidden">
            {/* Header */}
            <div
              className="p-[24px] flex items-start gap-[20px]"
            ...
            >
              ...
              <div>
                ...
                <p className="text-[13px] italic text-[var(--c-neutral-500)] mt-[8px]">"{persona.quote}"</p>
              </div>
            </div>
                ...
                <ul className="space-y-[6px]">
                  {persona.goals.map((g, i) => (
                    <li key={i} className="text-[12.5px] text-[var(--c-neutral-700)] flex items-start gap-[6px]">
                      <span className="text-[var(--c-success)] mt-[1px]">↑</span>{g}
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="p-[20px]">
                ...
                <ul className="space-y-[6px]">
                  {persona.painPoints.map((p, i) => (
                    <li key={i} className="text-[12.5px] text-[var(--c-neutral-700)] flex items-start gap-[6px]">
                      <span className="text-[var(--c-error)] mt-[1px]">✕</span>{p}
                    </li>
                  ))}
                </ul>
              </div>
              ...
              <div className="p-[20px]">
                ...
                <ul className="space-y-[6px]">
                  {persona.behaviors.map((b, i) => (
                    <li key={i} className="text-[12.5px] text-[var(--c-neutral-700)] flex items-start gap-[6px]">
                      <span className="text-[var(--c-primary)] mt-[1px]">→</span>{b}
                    </li>
                  ))}
                </ul>
              </div>
